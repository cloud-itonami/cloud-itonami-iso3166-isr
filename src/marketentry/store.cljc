(ns marketentry.store
  "SSoT for the ISR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems IL" :portal "Merkava/e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-il-entity? true :has-il-entity? true
             :requires-company-no? true :company-no-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ISR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Merkava/e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-il-entity? true :has-il-entity? true
             :requires-company-no? true :company-no-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Merkava/e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ISR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Merkava/e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-il-entity? true :has-il-entity? false
             :requires-company-no? true :company-no-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ISR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Merkava/e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-il-entity? true :has-il-entity? true
             :requires-company-no? true :company-no-verified? false
             :drafted? false :submitted? false
             :jurisdiction "ISR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Merkava/e-procurement"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-il-entity? has-il-entity?
                               requires-company-no? company-no-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-il-entity?)  (assoc :engagement/requires-il-entity? requires-il-entity?)
    (some? has-il-entity?)       (assoc :engagement/has-il-entity? has-il-entity?)
    (some? requires-company-no?)    (assoc :engagement/requires-company-no? requires-company-no?)
    (some? company-no-verified?)    (assoc :engagement/company-no-verified? company-no-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-il-entity? :engagement/has-il-entity?
   :engagement/requires-company-no? :engagement/company-no-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-il-entity? (boolean (:engagement/requires-il-entity? m))
     :has-il-entity? (boolean (:engagement/has-il-entity? m))
     :requires-company-no? (boolean (:engagement/requires-company-no? m))
     :company-no-verified? (boolean (:engagement/company-no-verified? m))
