# cloud-itonami-iso3166-isr

Open ISO 3166 Blueprint for **ISR**: Israel.
...
tax registration, and local-content rules in Israel, so the operator
...
- **Not the government of Israel.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Israeli-licensed counsel
...
(ISO 3166 `ISR`). Required capabilities:
