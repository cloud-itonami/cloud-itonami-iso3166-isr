...
`cloud-itonami-iso3166-isr` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Israeli-licensed counsel or a registered agent for whatever licensed
representation the law of Israel requires for public-procurement
filings.
